...
```
,-------------------------------------------.                              ,-------------------------------------------.
|  Tab   |  Q ω |  W σ |  E € |  R ® |  T þ |                              |  Y ← |  U ↓ |  I → |  O œ |  P π |  Bksp  |
|--------+------+------+------+------+------|                              |------+------+------+------+------+--------|
| Lshift |  A ª |  S ß |  D ð |  F đ |  G ŋ |                              |  H ħ |  J ̉  |  K ĸ |  L ł |  Ö ø |   Ä æ  |
|--------+------+------+------+------+------+-------------.  ,-------------+------+------+------+------+------+--------|
|Ctrl/Esc|  Z « |  X » |  C © |  V „ |  B “ |  Å   | <  > |  |F-keys|  ¨ ^ |  N ” |  M µ | ,  ; | . :  | -  _ | RShift |
`----------------------+------+------+------+------+------|  |------+------+------+------+------+----------------------'
                       |Adjust| LGUI | LAlt | Space| Nav  |  | Sym  | AltGr| Enter| RGUI | Menu |
                       |      |      |      |      |      |  |      |      |      |      |      |
                       `----------------------------------'  `----------------------------------'
...
|--------+------+------+------+------+------+-------------.  ,-------------+------+------+------+------+------+--------|
| LShift |   Z  |   X  |   C  |   V  |   B  |   Å  |CapsLk|  |F-keys|  ¨ ^ |   N  |   M  | ,  ; | . :  | -  _ | RShift |
`----------------------+------+------+------+------+------|  |------+------+------+------+------+----------------------'
                       |Adjust| LGUI | LAlt | Enter| Nav  |  | Sym  | AltGr| Space| RGUI | Menu |
                       |      |      |      |      |      |  |      |      |      |      |      |
                       `----------------------------------'  `----------------------------------'
...
|--------+------+------+------+------+------+-------------.  ,-------------+------+------+------+------+------+--------|
| LShift |   Z  |   X  |   C  |   V  |   B  | å    |CLock |  |      |  ¨   |   N  |   M  | , ;  | . :  | -  _ | RShift |
`--------+-------------+--------------------+------+------|  |------+------+--------------------+------+---------------'
